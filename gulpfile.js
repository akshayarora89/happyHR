...
// gulp.task('create-prod-version', function(callback) {
//     // gulp.run('prod-inject');
// });

// gulp.task('build', function() {
//     runSequence('sass-styles',['js-uglify', 'bower-uglify', 'minify-css', 'minify-bower-css', 'copy-index', 'copy-fonts', 'copy-images', 'copy-templates'], 'prod-inject', function() {
//         exec("whoami", function(error, result) { 
